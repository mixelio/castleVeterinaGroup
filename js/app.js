(() => {
            ...
            function showMoreActions(e) {
                ...
                if ("click" === targetType) {
                    if (targetEvent.closest("[data-showmore-button]")) {
                        const showMoreParentBlok = targetEvent.closest("[data-showmore-item]");
                        ...
                        if (!showMoreContent.classList.contains("_slide")) {
                            ...
                            showMoreParentBlok.classList.toggle("_active");
                        }
                    }
    ...
    function accordion() {
        const accord = document.querySelectorAll(".accordion__item");
    ...
    function filterBurger() {
        ...
        if (filterTitle) {
            ...
            if (filterTitle) filterTitle.addEventListener("click", (function(e) {
                ...
                } else blogFilter.style.paddingBottom = 0 + "px";
            }));
        }
    }
    filterBurger();
